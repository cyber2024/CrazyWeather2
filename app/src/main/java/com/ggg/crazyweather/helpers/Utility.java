...
public class Utility {
    ...
    public static String getFriendlyDate(Context context, long dateInMillis){
        Time time = new Time();
        time.setToNow();
    ...
    public static int getWeatherArtResourceId(int weatherId){
    ...
    public static boolean showNofitications(Context context){
        return getPrefs(context).getBoolean(context.getString(R.string.pref_notifications_key), Boolean.parseBoolean(context.getString(R.string.pref_notifications_default)));
    }
}
